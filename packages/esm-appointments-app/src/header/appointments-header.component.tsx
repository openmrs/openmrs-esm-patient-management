  ...
  const calendarFilterMultiselects = calendarFilters && (
    <div className={styles.calendarFilters}>
      <MultiSelect
        ...
        key={`service-${calendarFilters.serviceOptions.map((option) => option.uuid).join('-')}`}
      ...
      <MultiSelect
        ...
        key={`provider-${calendarFilters.providerOptions.map((option) => option.uuid).join('-')}`}
      ...
      <MultiSelect
        ...
        key={`location-${calendarFilters.locationOptions.map((option) => option.uuid).join('-')}`}
