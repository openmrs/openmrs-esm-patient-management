...
import { QueueTableByStatusPage } from './pages/queue-table-by-status-page.component';
      ...
      <SWRConfig value={swrConfiguration}>
        <BrowserRouter basename={serviceQueuesBasename}>
          <Routes>
            ...
            <Route path="/queue-table-by-status/:queueUuid" element={<QueueTableByStatusPage />} />
            <Route path="/queue-table-by-status/:queueUuid/:statusUuid" element={<QueueTableByStatusPage />} />
