  ...
  return (
    <>
      <div className={styles.cardContainer}>
        <WardCard label="patients" headerLabel="To Admit" value={admittedCount} />
        <WardCard label="patients" headerLabel="Admitted" value={toAdmitCount} />
        <WardCard label="patients" headerLabel="To Discharge" value={toDischargeCount} />
      </div>
      <div className={styles.container}>
        <Tabs>
          <TabList contained fullWidth className={styles.tabsContainer}>
            <Tab className={styles.tab}>{t('toAdmit', `To Admit (${admittedCount})`)}</Tab>
            <Tab className={styles.tab}>{t('admitted', `Admitted (${toAdmitCount})`)}</Tab>
            <Tab className={styles.tab}>{t('discharged', `To Discharge (${toDischargeCount})`)}</Tab>
          </TabList>
          <TabPanels>
            <TabPanel>
              <ActivePatientsTable status="pending" setPatientCount={setAdmittedCount} />
            </TabPanel>
            <TabPanel>
              <AdmittedPatientsList status="completed" setPatientCount={setToAdmitCount} />
            </TabPanel>
            <TabPanel>
              <DischargedPatientsList status="" setPatientCount={setToDischargeCount} />
            </TabPanel>
          </TabPanels>
        </Tabs>
      </div>
