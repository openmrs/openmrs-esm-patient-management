        ...
        <Row>
          ...
          <Column>
            <Input
              ...
              light
              placeholder={
                !patientIdentifiersMap[identifierType.uuid].sourceSelected.autoGenerationOption.manualEntryEnabled
                  ? `${t('autoGeneratedPlaceholderText', 'Auto-generated')}`
                  : patientIdentifiersMap[identifierType.uuid].sourceSelected.autoGenerationOption.manualEntryEnabled &&
                    patientIdentifiersMap[identifierType.uuid].sourceSelected.autoGenerationOption
