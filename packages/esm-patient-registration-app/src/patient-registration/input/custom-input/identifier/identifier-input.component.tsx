        ...
        <Row>
          ...
          <Column>
            <Input
              ...
              light
              placeholder={
                !identifierType.sourceSelected.autoGenerationOption.manualEntryEnabled
                  ? `${t('autoGeneratedPlaceholderText', 'Auto-generated')}`
                  : identifierType.sourceSelected.autoGenerationOption.manualEntryEnabled &&
                    identifierType.sourceSelected.autoGenerationOption.automaticGenerationEnabled
                  ? `${t('autoGeneratedPlaceholderText', 'Auto-generated')}`
                  : `${t('enterIdentifierPlaceholderText', 'Enter Identifier')}`
              }
              labelText={identifierType?.name}
              name={name}
              disabled={!identifierType.sourceSelected.autoGenerationOption.manualEntryEnabled}
            />
          </Column>
        </Row>
      )}
